...
class TestContainer(TestCase):
    ...
    def test_id_product_error(self, product_id):
        with self.assertRaises(ValueError):
            Container(product_id, '11111111111', '25/02/2019', 1, temp_min=1, temp_max=10,
    ...
    def test_id_producer(self, producer_id):
        with self.assertRaises(ValueError):
            Container("Apples", producer_id, '25/02/2019', 1, temp_min=1, temp_max=10,
                      hum_min=10, hum_max=90, room=self.room)
    ...
    def test_quantity(self, quantity):
        with self.assertRaises(ValueError):
            Container("Apples", '11111111111', '25/02/2019', quantity, temp_min=1, temp_max=10,
                      hum_min=10, hum_max=90, room=self.room)

    @parameterized.expand(['25/02/19', '25/02', '25-02-2019'])
    def test_limit(self, limit):
        with self.assertRaises(ValueError):
            Container("Apples", '11111111111', limit, 1, temp_min=1, temp_max=10,
                      hum_min=10, hum_max=90, room=self.room)
    ...
    def test_min_temp(self, temp_min):
        with self.assertRaises(ValueError):
            Container("Apples", '11111111111', '25/02/2019', 1, temp_min=temp_min, temp_max=10,
                      hum_min=10, hum_max=90, room=self.room)
    ...
    def test_max_temp(self, temp_max):
        with self.assertRaises(ValueError):
            Container("Apples", '11111111111', '25/02/2019', 1, temp_min=1, temp_max=temp_max,
                      hum_min=10, hum_max=90, room=self.room)
    ...
    def test_min_hum(self, hum_min):
        with self.assertRaises(ValueError):
            Container("Apples", '11111111111', '25/02/2019', 1, temp_min=1, temp_max=10,
    ...
    def test_temp_relation(self, temp_min, temp_max):
        with self.assertRaises(ValueError):
            Container("Apples", '11111111111', '25/02/2019', 1, temp_min=temp_min, temp_max=temp_max,
                      hum_min=10, hum_max=90, room=self.room)
